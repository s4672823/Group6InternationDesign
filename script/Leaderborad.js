var leaderboardState = function(game){
    ...
    this.style = { font: "bold 34px Comic Sans MS", fill: "#fff", tabs: [ 100, 300 ] };
    this.textStyle = { font: "28px Comic Sans MS",stroke: '#ffffff', strokeThickness: 4, fill: "#BE5446", tabs: [ 100, 300 ] };
    this.styleTextH = { font: "bold 58px Comic Sans MS", fill: "#fff", boundsAlignH: "center", boundsAlignV: "middle" };
    this.styleTextH2 = { font: "bold 36px Comic Sans MS", fill: "#fff", boundsAlignH: "center", boundsAlignV: "middle" };
