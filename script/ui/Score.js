var Score = function(game){
    ...
    Score.prototype = {
        ...
        createScore: function(){
            ...
            var scoreFont = "50px Comic Sans MS";
            this.scoreLabel = game.add.text(game.world.centerX,game.height-100,'0',{font: scoreFont, fill: '#00164D', stroke: '#ffffff', strokeThickness: 6});
